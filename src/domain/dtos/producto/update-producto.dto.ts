export class UpdateProductoDto {
    ...
    static create(props: { [key: string]: any }): [string?, UpdateProductoDto?] {
      const { id_producto, nombre_prod, descripcion_prod, categoria, precio_prod } = props;
      ...
      if (!nombre_prod && !descripcion_prod && !categoria && !precio_prod) {
        return ['At least one property must be provided'];
      }
  
      return [undefined, new UpdateProductoDto(id_producto, nombre_prod, descripcion_prod, categoria, precio_prod)];
    }
  }
...
CREATE TABLE "transaccion" (
    ...
    "cantidad_trans" DOUBLE PRECISION NOT NULL,
...
ALTER TABLE "producto" ADD CONSTRAINT "producto_ID_Artesano_fkey" FOREIGN KEY ("ID_Artesano") REFERENCES "artesano"("id_artesano") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "producto" ADD CONSTRAINT "producto_ID_Categoria_fkey" FOREIGN KEY ("ID_Categoria") REFERENCES "categoria"("id_categoria") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "transaccion" ADD CONSTRAINT "transaccion_ID_Comprador_fkey" FOREIGN KEY ("ID_Comprador") REFERENCES "comprador"("id_comprador") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "transaccion" ADD CONSTRAINT "transaccion_ID_Producto_fkey" FOREIGN KEY ("ID_Producto") REFERENCES "producto"("id_producto") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "carrito" ADD CONSTRAINT "carrito_ID_Comprador_fkey" FOREIGN KEY ("ID_Comprador") REFERENCES "comprador"("id_comprador") ON DELETE CASCADE ON UPDATE CASCADE;
